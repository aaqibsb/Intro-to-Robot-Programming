...
def main():
    ...
    parser.add_argument('-aruco_id', type=float, default=0,
                        help='the aruco ID to spawn on robot3')
    ...
    if args.turtlebot_type is not None:
        if args.robot_name == "robot1":
            sdf_file_path = os.path.join(
                get_package_share_directory('tb3_gazebo'), 'models',
                f'turtlebot3_waffle', 'model_robot1.sdf')
        elif args.robot_name == "robot2":
            if args.aruco_id == 0:
                sdf_file_path = os.path.join(
                    get_package_share_directory('tb3_gazebo'), 'models',
                ...
                sdf_file_path = os.path.join(
                    get_package_share_directory('tb3_gazebo'), 'models',
                    f'turtlebot3_waffle', 'model_robot2_aruco0.sdf')
        elif args.robot_name == "robot3":
            sdf_file_path = os.path.join(
                get_package_share_directory('tb3_gazebo'), 'models',
                f'turtlebot3_waffle', 'model_robot3.sdf')
    else:
    ...
    q = quaternion_from_euler(0, 0, args.yaw)
