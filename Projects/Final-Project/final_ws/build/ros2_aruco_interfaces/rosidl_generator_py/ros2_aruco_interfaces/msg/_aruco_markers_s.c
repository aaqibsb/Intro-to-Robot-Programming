...
bool ros2_aruco_interfaces__msg__aruco_markers__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_aruco_interfaces.msg._aruco_markers.ArucoMarkers", full_classname_dest, 53) == 0);
  }
  ros2_aruco_interfaces__msg__ArucoMarkers * ros_message = _ros_message;
  {  // header
...
PyObject * ros2_aruco_interfaces__msg__aruco_markers__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_aruco_interfaces.msg._aruco_markers");
